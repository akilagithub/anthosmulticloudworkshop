...
### [📽️ Video Walk Through: Building Anthos platform](https://threadit.app/thread/h2pq6jkd7nck89ej0wsh?utm_medium=referral-link)

[📽️ Video Walk Through: Troubleshooting failed pipelines](https://threadit.app/thread/vff54h8fep4xsxyoqkh3?utm_medium=referral-link)
...
- From the GCP lab, select `Open Google Console`, follow the prompts, **accept terms** and open Cloud Shell.
...
> NOTE: This lab is intended to be run from Cloud Shell.
...
### [📽️ Video Walk Through: User setup](https://threadit.app/thread/xxkgaitp7spclcmt7vqj?utm_medium=referral-link)
...
#### [Lab 4a: Cloud Monitoring Setup](/platform_admins/docs/cloud-mon-setup.md)
...
#### [Lab 4b: Anthos Service Mesh - Metrics, SLOs and Alerts](/platform_admins/docs/asm-slo.md)

> "I, application operator, want to set SLOs and alerts for services running in my clusters"
