...
gcloud container hub memberships register ${EKS} --project=${PROJECT_ID} --context=eks_${EKS} --kubeconfig=kubeconfig_${EKS} --enable-workload-identity --public-issuer-url=${EKS_OIDC_CLUSTER_ISSUER_URL}
