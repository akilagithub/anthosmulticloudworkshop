...
module "acm" {
  source  = "github.com/kenthua/terraform-google-kubernetes-engine//modules/acm?ref=workaround_wait"
...
module "hub" {
  source  = "github.com/kenthua/terraform-google-kubernetes-engine//modules/hub?ref=hub_wi"
