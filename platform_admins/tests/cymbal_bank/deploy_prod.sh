...
echo -e "\n"
echo_cyan "*** Deploying Cymbal Bank app to ${EKS2} cluster... ***\n"
kubectl --context=${EKS2} apply --kustomize ${SCRIPT_DIR}/yaml/overlays/${STAGE}/eks
kubectl --context=${EKS2} --namespace ${APP_NS} delete statefulset/accounts-db
kubectl --context=${EKS2} --namespace ${APP_NS} delete statefulset/ledger-db
...
is_deployment_ready ${EKS2} ${APP_NS} balancereader
is_deployment_ready ${EKS2} ${APP_NS} contacts
is_deployment_ready ${EKS2} ${APP_NS} frontend
is_deployment_ready ${EKS2} ${APP_NS} ledgerwriter
is_deployment_ready ${EKS2} ${APP_NS} loadgenerator
is_deployment_ready ${EKS2} ${APP_NS} transactionhistory
is_deployment_ready ${EKS2} ${APP_NS} userservice
